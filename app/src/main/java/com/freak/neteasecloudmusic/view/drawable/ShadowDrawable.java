package com.freak.neteasecloudmusic.view.drawable;
...
public class ShadowDrawable extends Drawable {
     ...
     * @param bgColor      设置阴影的view的背景颜色
     * @param shapeRadius  view的弧度
     * @param shadowColor  阴影颜色
     * @param shadowRadius 阴影弧度
     * @param offsetX      view层距离阴影层的X轴位置
     * @param offsetY      view层距离阴影层的Y轴位置
     */
