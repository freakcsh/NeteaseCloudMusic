...
/**
 * Created by hboxs020 on 2017/9/22.
 */
...
//    }
    ...
    public static String getUA(Context ctx) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            return new WebView(ctx).getSettings().getDefaultUserAgent(ctx) + "__" + systemUa;
        } else {
            return new WebView(ctx).getSettings().getUserAgentString() + "__" + systemUa;
        }
    }
