package com.freak.neteasecloudmusic.modules.find.recommend.songlist.adapter;
...
import static com.freak.neteasecloudmusic.modules.find.recommend.entity.MultipleItem.NEW_SONG_LIST;
import static com.freak.neteasecloudmusic.modules.find.recommend.entity.MultipleItem.RECOMMEND_SONG_LIST;
    ...
    protected void convert(BaseViewHolder helper, SongListEntity.PlaylistsBean item) {
        switch (item.getItemType()) {
            ...
            case RECOMMEND_SONG_LIST:
                Glide.with(mContext).load(item.getCoverImgUrl()).thumbnail(0.1f).into((ImageView) helper.getView(R.id.img_bg_song_list));
